...
module.exports.EngineeringUnit = {
...
module.exports.EngineeringUnitName = usc.invert(module.exports.EngineeringUnit);
...
module.exports.EventTransitionBit = {
  TO_OFFNORMAL: 0,
  TO_FAULT: 1,
  TO_NORMAL: 2
};

module.exports.EventTransitionBitName = usc.invert(module.exports.EventTransitionBit);
...
module.exports.ObjectTypeSupported = {
  ANALOG_INPUT: 0,
  ANALOG_OUTPUT: 1,
  ANALOG_VALUE: 2,
  BINARY_INPUT: 3,
...
module.exports.ObjectTypeSupportedName = usc.invert(module.exports.ObjectTypeSupported);
...
module.exports.ResultFlagName = usc.invert(module.exports.ResultFlag);
...
module.exports.StatusFlagName = usc.invert(module.exports.StatusFlag);
...
module.exports.PropertyStateName = usc.invert(module.exports.PropertyState);
